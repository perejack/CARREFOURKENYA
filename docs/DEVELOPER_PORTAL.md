...
**See:** [Full API Reference](./MPESA_VERIFICATION_GUIDE.md#getmpesatokenconsumerkey-consumersecret)

---

#### `queryMpesaPaymentStatus(token, checkoutId, config)`

Query payment status from Safaricom.

```javascript
const response = await queryMpesaPaymentStatus(token, checkoutId, {
  businessShortCode: '3581047',
  passkey: 'passkey'
});
```

**See:** [Full API Reference](./MPESA_VERIFICATION_GUIDE.md#querympesapaymentstatutoken-checkoutrequestid-config)
...
- **[MPESA_VERIFICATION_GUIDE.md](./MPESA_VERIFICATION_GUIDE.md)** - Complete reference (2,000+ lines)
...
- **Direct Integration:** 1-3 seconds (Safaricom API)
- **Proxy Integration:** 1-4 seconds (proxy + Safaricom API)
...
This integration is provided as-is for M-Pesa payment projects.

---

## 🎯 Next Steps

1. **Choose your integration option** (Direct or Proxy)
2. **Read the relevant guide** (5-30 minutes)
3. **Follow the implementation examples** (10-20 minutes)
4. **Test with a real payment** (5 minutes)
5. **Deploy to production** (5-10 minutes)

**Total Time to Production:** 25-75 minutes
